...
//ContinueBlockChain:既存のブロックチェーンに追加するために呼び出される。
...
//InitBlockChain:新しいBlockChainをstart。
...
// AddBlock:ブロックチェーンにBlockタイプのユニットを追加。
...
//BlockChain構造体を受け取り、それをBlockCHainIterator構造体として返す。
